...
double trapezoidal::integral_prec(double x_min, double x_max, std::function<double(double)> func, double precision)
{
    if (precision < 0) { throw std::invalid_argument("trapezoidal::integral_prec : precision must be positive."); }
